...
import { useScreenInit } from '@/hooks/use-screen-init';
            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {status === 'error' && (
                  <p
                    role="alert"
                    className="rounded-xl border border-red-400/30 bg-red-400/10 px-3 py-2 text-sm text-red-600 dark:text-red-300"
                  >
